  ...
  return (
    <Modal onClose={onClose} maxWidth="max-w-2xl">
      ...
      <div className="mt-4 flex flex-col justify-between gap-2 sm:flex-row sm:items-start">
        <div>
          <h3 className="font-display text-xl font-semibold text-charcoal-600">
            {shortName}
          </h3>
      ...
      <div className="mt-5 grid gap-5 sm:grid-cols-2">
        <div className="rounded-xl bg-gold-100/70 p-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-charcoal-600/50">
            Payment Summary
          </p>
          ...
          <div className="mt-3 h-2 w-full overflow-hidden rounded-full bg-charcoal-600/10">
            <div
              ...
              style={{ width: `${deal.percentPaid}%` }}
            />
          </div>
          <p className="mt-1 text-right text-[11px] text-charcoal-600/50">
            {deal.percentPaid}%
          </p>
        </div>
