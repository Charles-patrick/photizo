...
export default function NotificationsPanel() {
  const preview = dashboardNotifications.slice(0, 4);

  return (
    <div className="rounded-2xl bg-gold-50 p-5 sm:p-6">
      <div className="flex items-center justify-between">
        <h2 className="font-display text-lg font-semibold text-ember-500">
          Notifications
        </h2>
        <Link
          ...
          return (
            <div key={notification.id} className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 text-xs leading-relaxed text-charcoal-600/65">
                  {notification.description}
                </p>
                <p className="mt-1 text-[11px] text-charcoal-600/45">
                  {notification.time}
                </p>
              </div>
            </div>
