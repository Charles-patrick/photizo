...
export default function Notifications() {
  ...
  const filtered = useMemo(() => {
    ...
    if (!query) return dashboardNotifications;
    return dashboardNotifications.filter(
      (n) =>
  ...
  return (
    <div>
      ...
      <div className="mt-6 flex flex-col divide-y divide-charcoal-600/10 rounded-2xl bg-gold-50">
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-0.5 text-sm text-charcoal-600/65">
                  {notification.description}
                </p>
              </div>
              <span className="shrink-0 whitespace-nowrap text-xs text-charcoal-600/45">
                {notification.time}
              </span>
            </div>
          );
        ...
        {filtered.length === 0 && (
          <p className="p-6 text-center text-sm text-charcoal-600/70">
