...
export default function Faq() {
  ...
  return (
    <section className="bg-gold-50 py-12 sm:py-16 md:py-20 lg:py-24">
      {/*
        Same fix as the rest of the page: one gutter that grows gradually
        instead of jumping straight from px-15 to px-44 at lg.
      */}
